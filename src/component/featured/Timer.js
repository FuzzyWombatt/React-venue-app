...
const Timer = () => {
    ...
    const renderItem = (time) => {
        ...
        return(
        <div className='flex flex-row bg-turqoise-900 text-white font-roboto'>
            <div className='flex flex-col items-center border-r-2 border-turqoise-500 lh-80'>
                <div className='mt-3 text-6xl pl-3 pr-3'>{days} </div>
                <div className='ml-6 mr-6 mb-3'>Days</div>
            </div>        
            <div className='flex flex-col items-center border-r-2 border-turqoise-500'>
            ...
            <div className='flex flex-col items-center border-turqoise-500'>
    ...
    // empty array at end to keep it from firing constantly
    useEffect(() => {
    ...
    return (
        <Slide left delay={800}>
                <div className='flex flex-col w-min-content absolute bottom-0'>
                    <header className='bg-turqoise-300 w-3/5 font-Righteous text-white text-xl text-center'>Event starts in</header>
                    {renderItem(time)}
                </div>
        </Slide>
    )
